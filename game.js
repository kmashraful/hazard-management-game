...
import { AlertCircle, Shield, Waves, Flame, Wind, Home, TrendingDown } from 'lucide-react';
...
const HazardManagementGame = () => {
  ...
  const [probMode, setProbMode] = useState(null);
  ...
  const hazardIcons = {
    ...
    Earthquake: <TrendingDown className="w-5 h-5" />,
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-2xl p-8">
          ...
          <div className="bg-blue-50 p-6 rounded-lg mb-6">
            ...
            <ul className="space-y-2 text-gray-700">
              <li>• Four groups manage coastal communities over 5 years</li>
              <li>• Each group has a different budget to invest in hazard mitigation</li>
              <li>• Choose wisely from 17 different mitigation strategies</li>
              <li>• Natural disasters will strike randomly based on probability</li>
              <li>• Goal: Minimize damage while maximizing cost-effectiveness!</li>
            </ul>
          </div>
      ...
      return (
        <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-cyan-900 p-8 flex items-center justify-center">
          <div className="max-w-2xl bg-white rounded-lg shadow-2xl p-8">
            ...
            <p className="text-gray-600 mb-8 text-center">Choose how to determine disaster probabilities for the simulation</p>
              ...
              <div>
                {currentYearResult.results[groupNames[0]].hazards.length === 0 ? (
                  <div className="bg-green-50 p-6 rounded-lg mb-6 text-center">
                    <h3 className="text-2xl font-bold text-green-800">🎉 No Hazards This Year!</h3>
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    <h3 className="text-2xl font-bold">
                      ...
                      {index === 0 && <span className="ml-3 text-3xl">🏆</span>}
                    </h3>
                    {index === 0 && (
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-bold">
                        {result.efficiencyScore === Infinity ? '∞' : result.efficiencyScore.toFixed(2)}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div key={groupName} className="mb-4">
                  ...
                  <div className="space-y-1 text-sm">
                    {groups[groupName].yearImpacts.map(impact => (
                      <div key={impact.year}>
                        Year {impact.year}: {impact.hazards.length > 0 ? `${impact.hazards.join(', ')} → ${impact.damage} damage` : 'No hazards → 0 damage'}
                      </div>
                    ))}
                  </div>
                </div>
...
export default HazardManagementGame;
